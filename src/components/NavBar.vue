<template>
  <header class="navbar">
    <div class="navbar__container">
      ...
      <!-- Menú inferior -->
      <!-- Fragmento del bloque del menú en el nav -->
      <nav class="navbar__menu">
        <router-link to="/shop" class="navbar__menu-item"
          :class="{ 'navbar__menu-item--active': $route.path.startsWith('/shop') }">
          Tienda
        </router-link>
        <router-link to="/guia" class="navbar__menu-item"
          :class="{ 'navbar__menu-item--active': $route.path.startsWith('/guia') }">
          Guía
        </router-link>
        <router-link to="/contacto" class="navbar__menu-item"
          :class="{ 'navbar__menu-item--active': $route.path.startsWith('/contacto') }">
          Contacto
        </router-link>
        <!-- Nuevo enlace para Producto Autoria -->
        <router-link to="/producto-autoria" class="navbar__menu-item"
          :class="{ 'navbar__menu-item--active': $route.path.startsWith('/producto-autoria') }">
          Producto Autoria
        </router-link>
        <!-- Nuevo enlace para Producto Autoria -->
        <router-link to="/balon" class="navbar__menu-item"
          :class="{ 'navbar__menu-item--active': $route.path.startsWith('/balon') }">
          Balon
        </router-link>
